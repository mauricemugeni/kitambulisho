    ...
    <div class="inner">
        <h2 class="major"> Hey, <?php
                    if (isset($_SESSION['user'])) {
                        ...
                        echo 'Session Unset';
                    ?></h2>
        <p>Welcome to your profile. Here you can do two main things: add your important documents and report a found document.</p>
        <section class="features">
            ...
            <article>
                <a href="?report" class="image"><img src="images/profile-01.png" alt="" /></a>
            ...
            <article>
                <a href="?contact" class="image"><img src="images/profile-02.png" alt="" /></a>
                <h3 class="major">Feedback</h3>
                <p>We appreciate you on board. And we would like to here you thoughts.</p>
                <a href="?contact" class="special">Build, Customise!</a>
            </article>
        </section>
        
        <ul class="actions">
            <li><a href="?about" class="button">About Kitambulisho.com</a></li>
        </ul>
